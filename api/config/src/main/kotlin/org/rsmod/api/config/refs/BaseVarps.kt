...
object BaseVarps : VarpReferences() {
    ...
    val option_chat = find("option_chat")
    val option_pm = find("option_pm")
    val option_mouse = find("option_mouse")
    val option_chatfilter_disabled = find("option_chatfilter_disabled")
    ...
    val option_chat_colour_public_opaque = find("option_chat_colour_public_opaque")
    val option_chat_colour_private_opaque = find("option_chat_colour_private_opaque")
    val option_chat_colour_autochat_opaque = find("option_chat_colour_autochat_opaque")
    val option_chat_colour_broadcast_opaque = find("option_chat_colour_broadcast_opaque")
    val option_chat_colour_friendschat_opaque = find("option_chat_colour_friendschat_opaque")
    val option_chat_colour_clanchat_opaque = find("option_chat_colour_clanchat_opaque")
    val option_chat_colour_tradereq_opaque = find("option_chat_colour_tradereq_opaque")
    val option_chat_colour_challengereq_opaque = find("option_chat_colour_challengereq_opaque")
    val option_chat_colour_broadcast_split = find("option_chat_colour_broadcast_split")
    val option_chat_colour_guestclan_opaque = find("option_chat_colour_guestclan_opaque")
    val option_chat_colour_clanbroadcast_opaque = find("option_chat_colour_clanbroadcast_opaque")
    val questlist_colour_in_progress = find("questlist_colour_in_progress")
    val questlist_colour_not_started = find("questlist_colour_not_started")
    val questlist_colour_completed = find("questlist_colour_completed")
    val questlist_colour_unavailable = find("questlist_colour_unavailable")
    val option_chat_colour_didyouknow_opaque = find("option_chat_colour_didyouknow_opaque")
